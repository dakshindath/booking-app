  ...
  return (
    <div className="font-staynest max-w-6xl mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        <h1 className="text-2xl font-semibold text-staynest-dark-gray">
          Manage Listings
        </h1>
        <button
      ...
      {listings.length === 0 ? (
        <div className="text-center py-16 bg-white rounded-xl shadow-staynest border border-staynest-gray-border">
          <svg
            className="w-16 h-16 mx-auto text-staynest-light-gray mb-4"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
          ...
          <p className="text-staynest-dark-gray font-medium mb-2">
            No listings found
          </p>
          <p className="text-staynest-light-gray mb-6">
        ...
        <div className="grid grid-cols-1 gap-6 mb-10">
          {listings.map((listing) => (
            <div
              key={listing._id}
              className="bg-white rounded-xl shadow-sm hover:shadow-staynest transition-shadow border border-staynest-gray-border overflow-hidden"
            >
              <div className="md:flex">
                <div className="md:w-48 h-48 md:h-48 relative flex-shrink-0 bg-staynest-background overflow-hidden">
                  {listing.images && listing.images.length > 0 ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-staynest-background">
                      <svg
                        className="w-10 h-10 text-staynest-light-gray"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
                ...
                <div className="flex-grow px-6 py-4">
                  <h3 className="text-lg font-semibold text-staynest-dark-gray">
                    {listing.title}
                  </h3>
                  <p className="text-staynest-light-gray mb-2">
                    {listing.location}
                  </p>
                  <p className="text-staynest-dark-gray font-medium">
                  ...
                  <div className="mt-2 flex flex-wrap gap-2">
                    {listing.amenities.slice(0, 3).map((amenity, index) => (
                      <span
                        key={index}
                        className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-staynest-background text-staynest-dark-gray"
                      >
                        {amenity}
                      </span>
                    ))}
            ...
            <div className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium mb-2 text-staynest-dark-gray">
                      Listing Title
                    </label>
                    <input
                      type="text"
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3 max-h-48 overflow-y-auto p-2 border border-staynest-gray-border rounded-lg">
                    {standardAmenities.map((amenity) => (
                      <label
                        key={amenity}
                        className="flex items-center space-x-2 cursor-pointer hover:bg-staynest-background/30 p-2 rounded-lg"
                      >
                        <input
                          type="checkbox"
                        ...
                        />
                        <span className="text-sm text-staynest-dark-gray">
                          {amenity}
                        </span>
                      </label>
                    ))}
                  ...
                  {formData.images.length > 0 && (
                    <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                      {formData.images.map((image, index) => (
                        <div
                          key={index}
                          className="relative group rounded-lg overflow-hidden shadow-sm h-24"
                        >
                          <img
                            src={image}
                            alt=""
          ...
          <div className="bg-white rounded-xl shadow-staynest w-full max-w-md">
            <div className="p-6">
              <div className="flex items-center justify-center mb-4">
                <svg
                  className="w-12 h-12 text-staynest-pink"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <p className="text-center text-staynest-light-gray mb-6">
                ...
                <span className="font-medium">"{deletingListing?.title}"</span>?
